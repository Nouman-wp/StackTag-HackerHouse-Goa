      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-4">BetterBNS</h3>
            <p className="text-gray-300 mb-4">
              The ultimate platform for claiming .btc domains and showcasing your verifiable proof-of-work on the Stacks blockchain.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/explore" className="text-gray-300 hover:text-orange-400 transition-colors">Explore</Link></li>
              <li><Link to="/dashboard" className="text-gray-300 hover:text-orange-400 transition-colors">Dashboard</Link></li>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 BetterBNS. Built on Stacks Blockchain.
          </p>
          <p className="text-gray-400 text-sm mt-2 md:mt-0">
            Powered by Stacks • IPFS • MongoDB
          </p>
        </div>
      </div>
    </footer>
